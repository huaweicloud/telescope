...
// isCCEDisk check whether the mount point is for docker created by CCE or not
func isCCEDisk(mountPoint string) bool {
	return strings.HasPrefix(mountPoint, "/var/lib/docker") ||
		strings.HasPrefix(mountPoint, "/mnt/paas/kubernetes")
}
